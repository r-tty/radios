;*******************************************************************************
;  rdf.as - Relocatable Dynamic Modules driver (RDOFF 2.0).
...
DrvRDM		DB	"%BINFMT_RDM"
		TIMES	16-$+DrvRDM DB 0
		DD	DrvRDM_ET
		DW	DRVFL_BinFmt

DrvRDM_ET	DD	RDM_Init
		DD	NULL
		DD	RDM_Load
		DD	RDM_Unload
		DD	NULL
...
DrvRDM_Ctrl	DD	NULL
		...
		DD	NULL
		DD	NULL
		DD	RDM_CheckSignature
		DD	RDM_ResolveLinks
		DD	RDM_ResolveULinks
...
endp		;---------------------------------------------------------------
		...
		; RDM_Done - release driver memory blocks.
		; Input: none.
		; Output: CF=0 - OK;
		;	  CF=1 - error, AX=error code.
proc RDM_Done
